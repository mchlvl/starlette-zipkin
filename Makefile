...
check-sort:
	pipenv run isort *.py --check-only --profile black
check-mypy:
	pipenv run mypy *.py --ignore-missing-imports --follow-imports=skip --strict-optional
...
check: check-sort check-format check-lint  ## perform checks
